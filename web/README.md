...
upload a host directory. Seatbelt conversations require an
...
Failed and stopped runs show a notice in the conversation, with the technical
error under **Details**, including after a refresh. While a run is active,
**Stop** in the conversation header stops it.
