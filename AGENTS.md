...
- Preserve JSON/protocol compatibility. Update protocol tests and relevant
  ADRs when changing wire behavior.
...
- `plugins/`: execution, brains, sessions, and external adapters
