...
[ADR-0012](adr-0012-scalable-runtime-coordination.md), and
[ADR-0017](adr-0017-one-runtime-one-trust-domain.md)
...
- multiple agents (proposed in
  [ADR-0016](adr-0016-persistent-agents-and-async-messaging.md));
